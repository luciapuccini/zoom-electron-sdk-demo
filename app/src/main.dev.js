...
const API_KEY = 'qSf5uap0AL2Xbv6FFD3Glc1JlicF18xCpJ7p';
const API_SECRET = 'qwJtNz3qDtu2oAuSYEbKI7SpnStLE46PPvvT';
const initoptions = {
...
function sdkauthCB(status) {
  if (ZoomAuthResult.AUTHRET_SUCCESS == status) {
    let opts = {
      meetingstatuscb: () => console.log('noop'),
      meetinguserjoincb: () => console.log('noop'),
      meetinguserleftcb: () => console.log('noop'),
      meetinghostchangecb: () => console.log('noop'),
    };
    ...
    zoomaudio = zoommeeting.GetMeetingAudio();
    zoomvideo = zoommeeting.GetMeetingVideo();
...
function ProcSDKReady() {
  ...
  let ret = zoomauth.SDKAuth(API_KEY, API_SECRET);
  if (ret == 0) {
    console.log('startjoinUnLoginWindow');
    ...
    startjoinUnLoginWindow.loadURL(
      'file://' + __dirname + '/pages/start_join_without_login.html'
    );
  }
}
...
let functionObj = {
  ...
  authWithJwtToken: function (sdk_context) {
    console.log('🚀 ~ file: main.js ~ line 652 ~ JWT TOKEN?', sdk_context);
    ...
    if (ret == 0) {
      console.log('startjoinUnLoginWindow 2');
      startjoinUnLoginWindow = new BrowserWindow({
        width: 700,
        height: 400,
        webPreferences: {
  ...
  startunlogin: function (meetingnum, zoomaccesstoken, username) {
    ...
    console.log('try to start meeting', opt);
    let opts = {
      meetingstatuscb: () => console.log('noop'),
      meetinguserjoincb: () => console.log('noop'),
      meetinguserleftcb: () => console.log('noop'),
    ...
    console.log('SDK>>', zoomsdk.GetMeeting);
    let zoomMeet = zoomsdk.GetMeeting(opts);
    console.log('🚀 ~ file: main.js ~ line 686 ~ zoomMeet', zoomMeet);
    let ret = zoomMeet.StartMeetingWithOutLogin(opt);
    return ret;
  },
  ...
  isAutoTurnOffVideoWhenJoinMeetingEnabled: function (bEnable) {
    ...
    let ret = zoomsetvideo.Setting_IsAutoTurnOffVideoWhenJoinMeetingEnabled(
      opts
    );
  },
  ...
  enableAutoFitToWindowWhenViewSharing: function (bEnable) {
    ...
    let ret = zoomsetshare.Setting_EnableAutoFitToWindowWhenViewSharing(opts);
  },
  isAutoFitToWindowWhenViewSharingEnabled: function () {
    let ret = zoomsetshare.Setting_IsAutoFitToWindowWhenViewSharingEnabled();
  },
  enableAutoFullScreenVideoWhenViewShare: function (bEnable) {
    let opts = {
      bEnable: bEnable,
    };
    let ret = zoomsetshare.Setting_EnableAutoFullScreenVideoWhenViewShare(opts);
  },
  isAutoFullScreenVideoWhenViewShareEnabled: function () {
    let ret = zoomsetshare.Setting_IsAutoFullScreenVideoWhenViewShareEnabled();
  },
  isCurrentOSSupportAccelerateGPUWhenShare: function () {
    let ret = zoomsetshare.Setting_IsCurrentOSSupportAccelerateGPUWhenShare();
  },
  enableAccelerateGPUWhenShare: function (bEnable) {
    let opts = {
      bEnable: bEnable,
    };
    let ret = zoomsetshare.Setting_EnableAccelerateGPUWhenShare(opts);
  },
  isAccelerateGPUWhenShareEnabled: function () {
    let ret = zoomsetshare.Setting_IsAccelerateGPUWhenShareEnabled();
  },
  enableRemoteControlAllApplications: function (bEnable) {
    let opts = {
      bEnable: bEnable,
    };
    let ret = zoomsetshare.Setting_EnableRemoteControlAllApplications(opts);
  },
  isRemoteControlAllApplicationsEnabled: function () {
    let ret = zoomsetshare.Setting_IsRemoteControlAllApplicationsEnabled();
  },
  ...
  enableAutoFullScreenVideoWhenJoinMeeting: function (zn_bEnable) {
    ...
    let ret = zoomsetgeneral.Setting_EnableAutoFullScreenVideoWhenJoinMeeting(
      opts
    );
  },
  ...
  isDisplayReminderWindowWhenExitEnabled: function (bEnable) {
    ...
    let ret = zoomsetgeneral.Setting_IsDisplayReminderWindowWhenExitEnabled(
      opts
    );
  },
  ...
  enableSelectRecordFileLocationAfterMeeting: function (bEnable) {
    ...
    let ret = zoomsetrecord.Setting_EnableSelectRecordFileLocationAfterMeeting(
      opts
    );
  },
  isSelectRecordFileLocationAfterMeetingEnabled: function (bEnable) {
    ...
    let ret = zoomsetrecord.Setting_IsSelectRecordFileLocationAfterMeetingEnabled(
      opts
    );
  },
  ...
  isOptimizeFor3rdPartyVideoEditorEnabled: function (bEnable) {
    ...
    let ret = zoomsetrecord.Setting_IsOptimizeFor3rdPartyVideoEditorEnabled(
      opts
    );
  },
  ...
  isPlaceVideoNextToShareInRecordEnabled: function (bEnable) {
    ...
    let ret = zoomsetrecord.Setting_IsPlaceVideoNextToShareInRecordEnabled(
      opts
    );
  },
  ...
  enableInviteButtonOnMeetingUI: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableInviteButtonOnMeetingUI(
      opts
    );
  },
  ...
  setBottomFloatToolbarWndVisibility: function (bShow) {
    ...
    let ret = zoomconfiguration.MeetingConfig_SetBottomFloatToolbarWndVisibility(
      opts
    );
  },
  ...
  disablePopupMeetingWrongPSWDlg: function (bDisable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_DisablePopupMeetingWrongPSWDlg(
      opts
    );
  },
  enableAutoEndOtherMeetingWhenStartMeeting: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableAutoEndOtherMeetingWhenStartMeeting(
      opts
    );
  },
  enableLButtonDBClick4SwitchFullScreenMode: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableLButtonDBClick4SwitchFullScreenMode(
      opts
    );
  },
  ...
  prePopulateWebinarRegistrationInfo: function (email, userName) {
    ...
    let ret = zoomconfiguration.MeetingConfig_PrePopulateWebinarRegistrationInfo(
      opts
    );
  },
  ...
  redirectClickAudioMenuBTNEvent: function (bRedirect) {
    ...
    let ret = zoomconfiguration.MeetingConfig_RedirectClickAudioMenuBTNEvent(
      opts
    );
  },
  enableAudioButtonOnMeetingUI: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableAudioButtonOnMeetingUI(
      opts
    );
  },
  ...
  addCustomizedPictureResource: function (strPNGID, strPNGPath) {
    ...
    let ret = zoomcustomizedresource.Resource_AddCustomizedPictureResource(
      opts
    );
  },
  addCustomizedStringResource: function (
  ...
  setDirectShareStatusUpdateCB: function () {
    // let ret = zoomdirectshare.SetDirectShareStatusUpdateCB(
  ...
  switchMinimizeUIMode4FristScreenMeetingUIWnd: function (mode) {
    ...
    let ret = zoomuicontroller.MeetingUI_SwitchMinimizeUIMode4FristScreenMeetingUIWnd(
      opts
    );
  },
  ...
  enableAutoAdjustSpeakerVolumeWhenJoinAudio: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableAutoAdjustSpeakerVolumeWhenJoinAudio(
      opts
    );
  },
  enableAutoAdjustMicVolumeWhenJoinAudio: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableAutoAdjustMicVolumeWhenJoinAudio(
      opts
    );
  },
  ...
  enableHideFullPhoneNumber4PureCallinUser: function (bHide) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableHideFullPhoneNumber4PureCallinUser(
      opts
    );
  },
  enableLengthLimitationOfMeetingNumber: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableLengthLimitationOfMeetingNumber(
      opts
    );
  },
  ...
  setMaxDurationForOnlyHostInMeeting: function (nDuration) {
    ...
    let ret = zoomconfiguration.MeetingConfig_SetMaxDurationForOnlyHostInMeeting(
      opts
    );
  },
  enableLocalRecordingConvertProgressBarDialog: function (bShow) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableLocalRecordingConvertProgressBarDialog(
      opts
    );
  },
  enableApproveRemoteControlDlg: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableApproveRemoteControlDlg(
      opts
    );
  },
  enableDeclineRemoteControlResponseDlg: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableDeclineRemoteControlResponseDlg(
      opts
    );
  },
  enableLeaveMeetingOptionForHost: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableLeaveMeetingOptionForHost(
      opts
    );
  },
  enableVideoButtonOnMeetingUI: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableVideoButtonOnMeetingUI(
      opts
    );
  },
  enableEnterAndExitFullScreenButtonOnMeetingUI: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableEnterAndExitFullScreenButtonOnMeetingUI(
      opts
    );
  },
  ...
  redirectClickEndMeetingBTNEvent: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_RedirectClickEndMeetingBTNEvent(
      opts
    );
  },
  redirectFreeMeetingEndingReminderDlg: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_RedirectFreeMeetingEndingReminderDlg(
      opts
    );
  },
  redirectClickCustomLiveStreamMenuEvent: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_RedirectClickCustomLiveStreamMenuEvent(
      opts
    );
  },
  redirectClickParticipantListBTNEvent: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_RedirectClickParticipantListBTNEvent(
      opts
    );
  },
  ...
  redirectMeetingWarningMsg: function (
    bRedirectBadNetwork,
  ...
  enableAirplayInstructionWindow: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableAirplayInstructionWindow(
      opts
    );
  },
  ...
  enableAutoHideJoinAudioDialog: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableAutoHideJoinAudioDialog(
      opts
    );
  },
  ...
  disableSplitScreenModeUIElements: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_DisableSplitScreenModeUIElements(
      opts
    );
  },
  setShowAudioUseComputerSoundChkbox: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_SetShowAudioUseComputerSoundChkbox(
      opts
    );
  },
  ...
  disableTopMostAttr4SettingDialog: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_DisableTopMostAttr4SettingDialog(
      opts
    );
  },
  enableGrabShareWithoutReminder: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableGrabShareWithoutReminder(
      opts
    );
  },
  enableShowShareSwitchMultiToSingleConfirmDlg: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableShowShareSwitchMultiToSingleConfirmDlg(
      opts
    );
  },
  disableFreeMeetingRemainTimeNotify: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_DisableFreeMeetingRemainTimeNotify(
      opts
    );
  },
  disableFreeMeetingRemainTimeNotify: function (bEnable) {
  ...
  hideUpgradeFreeMeetingButton: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_HideUpgradeFreeMeetingButton(
      opts
    );
  },
  ...
  hideUpgradeWarningMsgForFreeUserWhenSchedule: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_HideUpgradeWarningMsgForFreeUserWhenSchedule(
      opts
    );
  },
  ...
  hideCopyInvitationOnInviteWindow: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_HideCopyInvitationOnInviteWindow(
      opts
    );
  },
  hideKeypadButtonOnMeetingWindow: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_HideKeypadButtonOnMeetingWindow(
      opts
    );
  },
  hideRemoteControlOnMeetingUI: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_HideRemoteControlOnMeetingUI(
      opts
    );
  },
  ...
  enableInputMeetingPasswordDlg: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableInputMeetingPasswordDlg(
      opts
    );
  },
  enableInputMeetingScreenNameDlg: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableInputMeetingScreenNameDlg(
      opts
    );
  },
  ...
  enableForceAutoStartMyVideoWhenJoinMeeting: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableForceAutoStartMyVideoWhenJoinMeeting(
      opts
    );
  },
  enableForceAutoStopMyVideoWhenJoinMeeting: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_EnableForceAutoStopMyVideoWhenJoinMeeting(
      opts
    );
  },
  disableAutoShowSelectJoinAudioDlgWhenJoinMeeting: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_DisableAutoShowSelectJoinAudioDlgWhenJoinMeeting(
      opts
    );
  },
  disableRemoteCtrlCopyPasteFeature: function (bEnable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_DisableRemoteCtrlCopyPasteFeature(
      opts
    );
  },
  ...
  inputMeetingPasswordAndScreenName: function (meeting_Password, screenName) {
    ...
    let ret = zoomconfiguration.MeetingConfig_InputMeetingPasswordAndScreenName(
      opts
    );
  },
  ...
  inputWebinarRegisterEmailAndScreenName: function (email, screenName) {
    ...
    let ret = zoomconfiguration.MeetingConfig_InputWebinarRegisterEmailAndScreenName(
      opts
    );
  },
  ...
  disableConfidentialWatermark: function (bDisable) {
    ...
    let ret = zoomconfiguration.MeetingConfig_DisableConfidentialWatermark(
      opts
    );
  },
  ...
  enableAlwaysShowMeetingControls: function (bEnable) {
    ...
    let ret = zoomsetaccessibility.Setting_EnableAlwaysShowMeetingControls(
      opts
    );
  },
  isAlwaysShowMeetingControlsEnable: function (bEnable) {
    ...
    let ret = zoomsetaccessibility.Setting_IsAlwaysShowMeetingControlsEnable(
      opts
    );
  },
  ...
  startRecording: function (recPath) {
    if (this.canStartRecording(false, 0) == 0) {
      let opts = {
        recPath: recPath,
      };
...
function createWindow() {
  ...
  if (ZoomSDKError.SDKERR_SUCCESS == ret) {
    ...
    if (ret == 0) {
      ...
      console.log('startjoinUnLoginWindow this one');
      startjoinUnLoginWindow = new BrowserWindow({
        width: 1000,
        height: 400,
        webPreferences: {
      ...
      startjoinUnLoginWindow.loadURL('file://' + __dirname + '/index.html');
    }
  }
}
